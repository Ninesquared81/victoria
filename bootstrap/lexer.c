...
struct lxl_lexer *init_lexer(struct lxl_string_view source) {
    if (lexer_is_initialised) {
        lexer.start = source.start;
        lexer.end = LXL_SV_END(source);
...
const char *token_type_string(struct lxl_token token) {
    ...
    case TOKEN_GREATER_GREATER_EQUALS: return "TOKEN_GREATER_GREATER_EQUALS";
    case TOKEN_LESS:                   return "TOKEN_LESS";
    case TOKEN_LESS_EQUALS:            return "TOKEN_LESS_EQUALS";
    case TOKEN_LESS_LESS:              return "TOKEN_LESS_LESS";
    case TOKEN_LESS_LESS_EQUALS:       return "TOKEN_LESS_LESS_EQUALS";
